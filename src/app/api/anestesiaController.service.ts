...
export class AnestesiaControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveHistoriaClinicaUsingPOST(body: Anestesia, observe?: 'body', reportProgress?: boolean): Observable<GenericResponsestring>;
    public saveHistoriaClinicaUsingPOST(body: Anestesia, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GenericResponsestring>>;
    public saveHistoriaClinicaUsingPOST(body: Anestesia, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GenericResponsestring>>;
    public saveHistoriaClinicaUsingPOST(body: Anestesia, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.request<GenericResponsestring>('post',`${this.basePath}/Anestesia/saveHistoriaClinica`,
            {
                body: body,
                withCredentials: this.configuration.withCredentials,
                headers: headers,
