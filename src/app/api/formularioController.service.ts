...
export class FormularioControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public saveFormularioUsingPOST(body: Formulario, observe?: 'body', reportProgress?: boolean): Observable<GenericResponsestring>;
    public saveFormularioUsingPOST(body: Formulario, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<GenericResponsestring>>;
    public saveFormularioUsingPOST(body: Formulario, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<GenericResponsestring>>;
    public saveFormularioUsingPOST(body: Formulario, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (body === null || body === undefined) {
            throw new Error('Required parameter body was null or undefined when calling saveFormularioUsingPOST.');
        }
