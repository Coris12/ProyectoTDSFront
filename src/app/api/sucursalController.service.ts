...
export class SucursalControllerService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getByIdUsingGET12(id: number, observe?: 'body', reportProgress?: boolean): Observable<Sucursal>;
    public getByIdUsingGET12(id: number, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Sucursal>>;
    public getByIdUsingGET12(id: number, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Sucursal>>;
    public getByIdUsingGET12(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling getByIdUsingGET12.');
        }
